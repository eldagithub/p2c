...
<div class="inner bg-light lter">
          <div class="row form-horizontal">
              <div class="col-lg-12">
              		<br>
                    <p class="lead"><s:text name="admin_page.admin_account.metaprocess_mngt.add.phase.title"/></p>
					<hr>
<s:form name="pForm3" action="#">					
                      <div class="form-group">
                        <label class="control-label col-lg-4"><s:text name="admin_page.admin_account.metaprocess_mngt.add.phase.name"/></label>
                        <div class="col-lg-8">
                        	<input id="nom" name="nom" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-lg-4"><s:text name="admin_page.admin_account.metaprocess_mngt.add.phase.description"/></label>
                        <div class="col-lg-8">
                        	<input id="nom" name="nom" type="text" class="form-control">
                        </div>
                      </div>
