...
<div class="inner bg-light lter">
          <div class="row form-horizontal">
              <div class="col-lg-12">
                    ...
                    <p class="text-muted"><s:text name="admin_page.admin_account.metaprocess_mngt.add.field.subtitle2"/></p>
					<hr>
					<s:form name="pForm3" action="#">					
                      <div class="form-group">
                        <label class="control-label col-lg-4"><s:text name="admin_page.admin_account.metaprocess_mngt.add.field.label"/></label>
                        <div class="col-lg-5">
					...
					<br><br>
                      <div class="form-group">
                       <label class="control-label col-lg-6"></label>
	                      <div class="col-lg-1 ">
	                        <input type="submit" value="<s:text name="button.label.validate"/>" class="btn btn-primary" onclick=''>
	                      </div>
                      </div>
              </div><!-- /.col-lg-12 -->
		</div>
