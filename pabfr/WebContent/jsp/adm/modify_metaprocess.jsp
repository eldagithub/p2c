...
<div class="inner bg-light lter">
	...
	<div id="phaseList">
		<br>
	        <div class="row">
	              <div class="col-lg-9">
	                    <p class="lead"><s:text name="admin_page.admin_account.metaprocess_mngt.modify.title"/> : Xxxxxxx</p>
	                    <p class="text-muted">
	                    	<s:text name="admin_page.admin_account.metaprocess_mngt.modify.fields"/>&nbsp;&nbsp;<a data-toggle="collapse" href="#collapseTwo" title="Cliquer pour afficher/masquer les champs"><i class="fa fa-toggle-down"></i></a></p>
	              </div><!-- /.col-lg-9 -->
	              <div class="col-lg-3">
		...
		<div id="collapseTwo" class="panel-collapse collapse">
			<s:iterator status="Status" begin="1" end="2">
	          <div class="row form-group">
		          <div class="col-lg-2"></div>
                  <label class="control-label col-lg-2 box_editable" contenteditable="true" title="<s:text name="label.subtitle.modify"/>">Champ n°<s:property value="%{#Status.count}"/></label>
		          <div class="col-lg-5"><input type="text" class=" form-control" readonly ></div>
		          <div class="col-lg-3"><i class="fa fa-times-circle box_clickable" title="<s:text name="label.subtitle.delete"/>" style="margin-top:10px;"></i></div>
		      </div>	
            </s:iterator>
			<s:iterator status="Status" begin="1" end="2">
	          <div class="row form-group">
		          ...
		          <div class="col-lg-5">
		          	<select class=" form-control" >
		          		<option>Item n°1</option><option>Item n°2</option><option>Item n°3</option>
		          	</select>
		          </div>
		          <div class="col-lg-3"><i class="fa fa-times-circle box_clickable" title="<s:text name="label.subtitle.delete"/>" style="margin-top:10px;"></i></div>
		      </div>	
