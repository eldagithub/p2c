...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/jsp/tdb/tdb.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/metisMenu.min.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/css/jquery-ui.css">
    <script src="<%=request.getContextPath()%>/js/jquery.js"></script>
</head>

<div class="inner bg-light lter" title="Contactez-nous pour personnaliser vos tableaux de bord comme celui-ci.">
...
<div class="container-fluid">
  <div class="row" id="mini-charts">
  	<div class="col-md-6 col-sm-4"><h2>Dashboard Example</h2></div>
    <div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-0 col-xs-10 col-xs-offset-0 hidden-xs panel sparklines">
      <div class="row collapse in" id="bars">
        <div class="col-xs-1 col-xs-offset-3">Hourly<br><span class="fa fa-user fa-2x"></span></div>
    	<div class="col-xs-2 border-right"><div id="bar1" class="bar-chart"></div></div>
  ...
  <div class="tab-content">
      ...
      <div class="tab-pane" id="revenue">
		...
		<div class="well well-sm text-center">
              ...
              <label class="btn btn-sm btn-default">
                <input name="options" id="option1" type="radio"> Day
              </label>
              <label class="btn btn-sm btn-default">
                <input name="options" id="option2" type="radio"> Week
              </label>
              <label class="btn btn-sm btn-default active">
                <input name="options" id="option3" type="radio"> Month
              </label>
            </div>
      ...
      <div class="tab-pane" id="network">
        <div class="container-fluid">
          <h4 class="text-center">Network Statistics</h4>
          <div class="row">
            <div class="col-sm-3 col-xs-6">
        ...
        <h6>2.85 GB of <strong>15 GB</strong></h6>
...
<script type="text/javascript">
	...
	$.getScript('<%=request.getContextPath()%>/js/jquery.flot.min.js',function(){
	  $.getScript('<%=request.getContextPath()%>/js/jquery.flot.pie.min.js',function(){
	    $.getScript('<%=request.getContextPath()%>/js/jquery.flot.resize.min.js',function(){
		...
		TINY.box.show({html:'Contactez-nous pour obtenir un tableau de bord comme celui-ci.',width:200,height:40,opacity:20, autohide:4, close:false,boxid:'error'});
</script>
