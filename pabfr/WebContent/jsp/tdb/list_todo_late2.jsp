...
<li class="time-label"><span class="bg-990000 label_process">TODO en retard</span></li>         
	...
	<s:iterator value="pptList" status="projetStatus">
		...
		<i class="fa fa-user bg-1A616F"></i>
		   <div class="timeline-item">
		     ...
		     <s:if test="tache.getType() != 'etape'"><br>Montant (<s:property value='tache.getType()' />) : <s:property escape="false" value='tache.getMontant()'  />&euro;</s:if>
	...
	<s:else>
		<li>
		   <div class="timeline-item">
		     <h3 class="timeline-header">Vous n'avez pas de t&acirc;ches en retard</h3>
		    </div>
		</li>
	</s:else>
