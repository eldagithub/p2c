...
<script>
	function overRefPhase(id){
		if (id == 0){
			document.getElementById("phase_details").innerHTML="<hr><b>Retravail total du process</b><br> Min : 2j<br> Max : 10j<br> Avg : 6j<br> Ecart-type : 5j";
		}else{
			document.getElementById("phase_details").innerHTML="<hr><b>Retravail de la phase n°"+id+"</b><br> Min : 1j<br> Max : 2j<br> Avg : 1,5<br> Ecart-type : 2";
		}
	}
...
<br>
          <div class="row form-horizontal">
              <div class="col-lg-9">
                    ...
                    <p class="text-muted"><s:text name="dashboard_page.label.reworking"/></p>
			  </div>
	          <div class="col-lg-3">
