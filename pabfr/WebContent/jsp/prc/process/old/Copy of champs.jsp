        ...
        <s:if test="champsList.size() > 0">
            ...
            <s:iterator value="champsList" status="champsStatus">
                <div class="p_p_label_donnee">
                    <s:property value="nom" /> - <s:property value='type' /> - <s:property value='value' />
                </div>
...
<s:if test="%{type=='select'}">
                            <select onchange="champsActive(<s:property value="id"/>, this)" class="form-control">

<s:generator val="listvalues" 
         separator=",">
