...
<script>
	function back(){
		$("#page_content").load('<%=request.getContextPath()%>/ref/listGare?objet.categorie=GARE');
	}
</script>
        ...
        <div class="row">
			<br>
              <div class="col-lg-12">
                    ...
                    <p class="text-muted"><s:text name="admin_page.delete.title"/>&nbsp;<s:text name="repository2.Name"/></p>
                    <hr>
                    <br><br>
