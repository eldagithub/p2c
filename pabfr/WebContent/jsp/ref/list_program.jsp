						...
						<tbody>
							<s:iterator value="objetList" status="UserStatus">
								<tr>
									...
									<td style="width:50px;"><a title="Cliquer pour mettre à jour les informations du patient" href="#" onclick='javascript: loadProgram(<s:property value="idref" />);' ><i class="fa fa-edit"></i></a></td>
									...
									<td style="width:50px;">
										<s:if test="idresponsable == 0">
											<a title="Cliquer pour créer un compte utilisateur au patient" href="#" onclick='javascript: addUserProgram(<s:property value="idref" />, "<s:property value="nom" />", "<s:property value="description" />");' ><i class="fa fa-user"></i></a>
										</s:if>
									</td>
	             				</tr>
	              			</s:iterator>
