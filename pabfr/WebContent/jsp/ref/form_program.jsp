...
<script>
	function validateFormP(){
		...
		if(nom != ""){
			$("#page_content").load('<%=request.getContextPath()%>/ref/updateProgram?objet.idref=' + document.getElementById("objet.idref").value
					+ '&objet.nom=' + nom
        ...
        <div class="row">
			<br>
              <div class="col-lg-12">
                    ...
                    <p class="text-muted"><s:text name="admin_page.modify.title"/>&nbsp;<s:text name="repository2.Name"/></p>
				<hr>
			</div>
		</div>
          <div class="row form-horizontal">
              <div class="col-lg-12">
					<s:form name="pFormP" action="#">
						...
						<input type="hidden" id="objet.idresponsable" name="objet.idresponsable" value="<s:property value="objet.idresponsable"/>">
