...
function    postAdd()
{
	...
	if (y){			
		this.$("#form_new_post").load('<%=request.getContextPath()%>/event/addReader?tolist=' + escape(document.getElementById("tolist").options[tolist.selectedIndex].value)
...
<s:form name="postForm"  action="#"  method="post"  >
		...
		<hr>
            <div class="form-group">
                        ...
                        <div class="col-lg-3">
					 		<select id="tolist" name="tolist" size="1" class="form-control" disabled>
...
<s:else>
		...
		<hr>
            <div class="form-group">
                        <label class="control-label col-lg-2"><s:text name="process_page.no_process"/></label>
			</div>
		</div>
</s:else>
